...
<div class = "topDiv">
    <div class="secondDiv"><!-- 覆盖个div，添加透明度 -->
        <br>
        <p align="center" class="loginTitle" style="margin-bottom: 5px;"><font color="#4ac9ff">Human</font><font color="#ff508b">Resourse</font></p>
        <p align="center" class="slogan" style="margin-bottom: 30px;">人力资源管理系统</p>
            ...
            <div class="formDiv" style="height: 400px">
                <table cellpadding="5" cellspacing="10">
                    ...
                    <tr height="50">
                        ...
                        <td>
                            <input  class="form-control" placeholder="请输入账号" onblur="checkUsername()" style="width: 190px; height: 35px;" type="text" id = "loginName" name="loginName" />
                        </td>
                    </tr>
                    <tr height="50">
                        <td>
